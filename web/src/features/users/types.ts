...
export const userSchema = z.object({
  ...
  quota: z.number(),
  used_quota: z.number(),
  subscription_total_quota: z.number().default(0),
  subscription_used_quota: z.number().default(0),
  subscription_remaining_quota: z.number().default(0),
  active_subscription_count: z.number().default(0),
  subscription_unlimited: z.boolean().default(false),
