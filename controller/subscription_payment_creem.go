...
func SubscriptionRequestCreemPay(c *gin.Context) {
	...
	// The plan's checkout currency is independent from the site's quota display.
	currency, err := model.NormalizeSubscriptionCurrency(plan.Currency)
	if err != nil {
		common.ApiErrorMsg(c, "套餐结算币种配置错误")
		return
	}
